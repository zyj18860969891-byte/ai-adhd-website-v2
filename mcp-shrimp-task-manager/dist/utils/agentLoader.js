...
export async function loadGlobalAgents() {
    try {
        ...
        try {
            ...
            const agentFiles = files.filter(file => file.endsWith(".md") || file.endsWith(".yaml") || file.endsWith(".yml"));
 ...
 */
export async function loadProjectAgents(projectRoot) {
    try {
 ...
 */
export async function getAllAvailableAgents(projectRoot) {
 ...
 */
export async function getAgentByName(agentName, projectRoot) {
