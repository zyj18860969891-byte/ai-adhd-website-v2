 ...
 */
export async function getExecuteTaskPrompt(params) {
    ...
    const implementationGuideTemplate = await loadPromptFromTemplate("executeTask/implementationGuide.md");
    ...
    const verificationCriteriaTemplate = await loadPromptFromTemplate("executeTask/verificationCriteria.md");
    ...
    const analysisResultTemplate = await loadPromptFromTemplate("executeTask/analysisResult.md");
    ...
    const dependencyTasksTemplate = await loadPromptFromTemplate("executeTask/dependencyTasks.md");
    ...
    const relatedFilesSummaryTemplate = await loadPromptFromTemplate("executeTask/relatedFilesSummary.md");
    ...
    const complexityTemplate = await loadPromptFromTemplate("executeTask/complexity.md");
